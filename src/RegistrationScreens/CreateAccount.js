...
export const CreateAccount = ({ navigation }) => {
    ...
    return (
        <View>
            ...
            <ImageBackground source={require('../img/dementiam.jpg')}
                style={{
                    flex: 1,
            ...
            <View style={{ backgroundColor: 'rgba(0, 0, 0, 0.7)', paddingHorizontal: 20, width: '100%', height: '100%', display: 'flex', flexDirection: 'column' }}>
                ...
                <View style={{ justifyContent: 'center', paddingTop: 20, paddingHorizontal: 20, paddingBottom: 60 }}>
                    <Text style={{ color: "black", fontSize: 30, textAlign: 'center' }}>SignUp</Text>
                </View>
                ...
                <View style={{ paddingHorizontal: 20, paddingTop: 50, borderRadius: 5 }}>
                    <TouchableOpacity style={{ backgroundColor: "#d8bfd8" }} onPress={handleSignUp}>
                        <Text style={{ color: 'black', textAlign: 'center', fontSize: 25, padding: 10 }}>SignUp</Text>
                    </TouchableOpacity>
                </View>
